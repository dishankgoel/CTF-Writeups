...
def admin_visit():
    admin_bot.get("http://0.0.0.0:16050/reports")
    while True:
        try:
...
def view_comment(comment_id):
    ...
    if not len(comments):
        ...
        return render_template('comment.html', comments=comments, id=comment_id)
